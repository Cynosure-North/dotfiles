...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if has('nvim')
      ...
      let g:palette_dim_background = '#181818'
      let g:palette_background = '#252525'
      let g:palette_bright_background = '#3b3b3b'
      let g:palette_dim_foreground = '#777777'
      let g:palette_foreground = '#b9b9b9'
      let g:palette_bright_foreground = '#dedede'

      let g:palette_red = '#ed4a46'
      let g:palette_green = '#70b433'
      let g:palette_yellow = '#dbb32d'
      let g:palette_blue = '#368aeb'
      let g:palette_magenta = '#eb6eb7'
      let g:palette_cyan = '#3fc5b7'
      let g:palette_orange = '#e67f43'
      let g:palette_violet = '#a580e2'

      let g:palette_bright_red = '#ff5e56'
      let g:palette_bright_green = '#83c746'
      let g:palette_bright_yellow = '#efc541'
      let g:palette_bright_blue = '#4f9cfe'
      let g:palette_bright_magenta = '#ff81ca'
      let g:palette_bright_cyan = '#56d8c9'
      let g:palette_bright_orange = '#fa9153'
      let g:palette_bright_violet = '#b891f5'
    endif
